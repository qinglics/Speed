...
public class FloatingIconService extends Service implements LocationListener {
  ...
  public void onCreate() {
    ...
    floatingSpeedText.setText(Html.fromHtml("<font color='#0000FF'>0</font>"));
  ...
  public void onDestroy() {
    if (floatingSpeedText != null) windowManager.removeView(floatingSpeedText);
...
public void onLocationChanged(Location location) {
	...
	if (this.floatingSpeedText != null) {
		this.floatingSpeedText.setText(Html.fromHtml("<font color='#0000FF'>" + String.valueOf(speedInMiles) + "</font>"));
	}
}
...
public void onProviderEnabled(String provider) {
	Toast toast = Toast.makeText(getApplicationContext(), "provider enabled", Toast.LENGTH_LONG);
	toast.show();
}
